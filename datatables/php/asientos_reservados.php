...
<?php
   $id_usuario = $_SESSION['id_usuario']; 
	...
	$aColumns = array( "id_reservas", "horario_ida","horario_vuelta","localidad","instituto","precio","asientos","ofertante","id_ofertante","id_usuario_reserva","id_trayecto","nombre_usuario_reserva");
	
	/* Indexed column (used for fast and accurate table cardinality) */
	$sIndexColumn = "id_reservas";
	 ...
	 */
	$sWhere = "WHERE id_ofertante='".$_SESSION['id_usuario']."'  " ;
