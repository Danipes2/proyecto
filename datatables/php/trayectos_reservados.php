...
<?php
   $id_usuario = $_SESSION['id_usuario']; 
	...
	$aColumns = array( "id_reservas", "horario_ida","horario_vuelta","localidad","instituto","precio","asientos","ofertante","id_ofertante","id_usuario_reserva","id_trayecto");
	 ...
	 */
	$sWhere = "WHERE id_usuario_reserva='".$_SESSION['id_usuario']."'  " ;
