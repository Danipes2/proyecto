...
require_once('../../funciones/sesiones.php');
	 ...
	 */
	$id=$_SESSION["usuario"];
	$aColumns = array( "id_mensajes","asunto","fecha","usuario_emisor","usuario_receptor","id_usuario_emisor","id_usuario_receptor");
	
	/* Indexed column (used for fast and accurate table cardinality) */
	$sIndexColumn = "id_mensajes";
	 ...
	 */
	$sWhere = "WHERE id_usuario_receptor='".$_SESSION['id_usuario']."'";
