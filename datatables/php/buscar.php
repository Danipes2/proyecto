...
<?php
   $localidad = $_SESSION['localidad1']; 
	...
	$aColumns = array( "id_trayecto", "precio","horario_ida","horario_vuelta","instituto","localidad","asientos","ofertante","id_ofertante");
	
	/* Indexed column (used for fast and accurate table cardinality) */
	$sIndexColumn = "id_trayecto";
	 ...
	 * on very large tables, and MySQL's regex functionality is very limited
	 ...
	 WHERE instituto_final =".$_SESSION['institutos'];
	 */
	$sWhere = "WHERE instituto='".$_SESSION['institutos']."' AND localidad='".$_SESSION['localidad1']."' AND asientos>0" ;
